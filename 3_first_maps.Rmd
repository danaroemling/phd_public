...
1. Regex function to count occurrences in corpus (both single and double)
2. Merge with coordinates
3. Get coordinates for underlying map
4. Plot the counts single and double
    - mapping_double_light
    - mapping_double_darkmode
    - mapping_double_lightmode_updated
    - mapping_single_darkmode
    - mapping_single_light
5. Exporting maps
